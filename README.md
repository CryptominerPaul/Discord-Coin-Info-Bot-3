# Discord-Coin-Info-Bot-3
Info-Bot that post Exchange Pricing POW,POS, &amp; MN Tier-lvl-4 Stats, and Expected Earnings

- A discord bot made for ESBC Coin, Supports 4 Tier Masternode, it can be easily adapted for any other currency.
...
- **%stats1:** get the current Bronze of the ESBC blockchain
- **%stats2:** get the current Silver stats of the ESBC blockchain
- **%stats3:** get the current Gold stats of the ESBC blockchain
- **%stats4:** get the current Platinum stats of the ESBC blockchain
...
- **%earnings1 ```[amount of MNs]```:** get the expected earnings per masternode Level 1
- **%earnings2 ```[amount of MNs]```:** get the expected earnings per masternode Level 2
- **%earnings3 ```[amount of MNs]```:** get the expected earnings per masternode Level 3
- **%earnings4 ```[amount of MNs]```:** get the expected earnings per masternode Level 4
